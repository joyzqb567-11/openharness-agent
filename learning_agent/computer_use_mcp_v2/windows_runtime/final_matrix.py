...
def _phase42_import_contracts() -> dict[str, Any]:  # 新增代码+Phase42WindowsFinalMatrix: 定义阶段合同导入 helper；如果没有这行代码，run 函数会塞满重复导入代码。
    try:  # 新增代码+Phase42WindowsFinalMatrix: 优先使用包模式导入；如果没有这行代码，正常 unittest 和 agent 入口无法加载阶段合同。
        from learning_agent.computer_use_mcp_v2.windows_runtime.approval import phase38_cli_line, run_phase38_approval_contract  # 新增代码+Phase42WindowsFinalMatrix: 导入 Phase38 approval 合同；如果没有这行代码，最终矩阵无法覆盖会话授权和禁止目标。
        from learning_agent.computer_use_mcp_v2.windows_runtime.coordinates import phase39_cli_line, run_phase39_coordinates_contract  # 新增代码+Phase42WindowsFinalMatrix: 导入 Phase39 坐标合同；如果没有这行代码，最终矩阵无法覆盖坐标和窗口状态。
        from learning_agent.computer_use_mcp_v2.windows_runtime.evidence import phase41_cli_line, run_phase41_image_results_contract  # 新增代码+Phase42WindowsFinalMatrix: 导入 Phase41 图片结果合同；如果没有这行代码，最终矩阵无法覆盖 artifact visibility。
        from learning_agent.computer_use_mcp_v2.windows_runtime.real_uia_smoke import phase35_cli_line, run_phase35_real_uia_smoke  # 新增代码+Phase42WindowsFinalMatrix: 导入 Phase35 UIA smoke 合同；如果没有这行代码，最终矩阵无法覆盖真实 UIA 依赖诊断边界。
        from learning_agent.computer_use_mcp_v2.windows_runtime.sendinput_executor import phase37_cli_line, run_phase37_sendinput_executor_contract  # 新增代码+Phase42WindowsFinalMatrix: 导入 Phase37 SendInput 合同；如果没有这行代码，最终矩阵无法覆盖安全假执行动作。
        from learning_agent.computer_use_mcp_v2.windows_runtime.session_runtime import phase40_cli_line, run_phase40_abort_cleanup_contract  # 新增代码+Phase42WindowsFinalMatrix: 导入 Phase40 runtime 合同；如果没有这行代码，最终矩阵无法覆盖 abort/cleanup。
        from learning_agent.computer_use_mcp_v2.windows_runtime.wgc_capture import phase36_cli_line, run_phase36_wgc_provider_contract  # 新增代码+Phase42WindowsFinalMatrix: 导入 Phase36 WGC provider 合同；如果没有这行代码，最终矩阵无法覆盖截图 provider 边界。
        ...
        if error.name not in {"learning_agent", "learning_agent.computer_use_mcp_v2.windows_runtime", "learning_agent.computer_use_mcp_v2.windows_runtime.approval", "learning_agent.computer_use_mcp_v2.windows_runtime.coordinates", "learning_agent.computer_use_mcp_v2.windows_runtime.evidence", "learning_agent.computer_use_mcp_v2.windows_runtime.real_uia_smoke", "learning_agent.computer_use_mcp_v2.windows_runtime.sendinput_executor", "learning_agent.computer_use_mcp_v2.windows_runtime.session_runtime", "learning_agent.computer_use_mcp_v2.windows_runtime.wgc_capture"}:  # 新增代码+Phase42WindowsFinalMatrix: 只允许目标包路径缺失时 fallback；如果没有这行代码，真实内部错误会被误吞。
            raise  # 新增代码+Phase42WindowsFinalMatrix: 重新抛出非路径类导入错误；如果没有这行代码，排查阶段合同 bug 会很困难。
        from computer_use_mcp_v2.windows_runtime.approval import phase38_cli_line, run_phase38_approval_contract  # 新增代码+Phase42WindowsFinalMatrix: 脚本模式导入 Phase38 合同；如果没有这行代码，bat 入口无法运行总验收。
        from computer_use_mcp_v2.windows_runtime.coordinates import phase39_cli_line, run_phase39_coordinates_contract  # 新增代码+Phase42WindowsFinalMatrix: 脚本模式导入 Phase39 合同；如果没有这行代码，bat 入口无法运行坐标验收。
        from computer_use_mcp_v2.windows_runtime.evidence import phase41_cli_line, run_phase41_image_results_contract  # 新增代码+Phase42WindowsFinalMatrix: 脚本模式导入 Phase41 合同；如果没有这行代码，bat 入口无法运行图片结果验收。
        from computer_use_mcp_v2.windows_runtime.real_uia_smoke import phase35_cli_line, run_phase35_real_uia_smoke  # 新增代码+Phase42WindowsFinalMatrix: 脚本模式导入 Phase35 合同；如果没有这行代码，bat 入口无法运行 UIA 诊断。
        from computer_use_mcp_v2.windows_runtime.sendinput_executor import phase37_cli_line, run_phase37_sendinput_executor_contract  # 新增代码+Phase42WindowsFinalMatrix: 脚本模式导入 Phase37 合同；如果没有这行代码，bat 入口无法运行 SendInput 合同。
        from computer_use_mcp_v2.windows_runtime.session_runtime import phase40_cli_line, run_phase40_abort_cleanup_contract  # 新增代码+Phase42WindowsFinalMatrix: 脚本模式导入 Phase40 合同；如果没有这行代码，bat 入口无法运行 runtime 合同。
        from computer_use_mcp_v2.windows_runtime.wgc_capture import phase36_cli_line, run_phase36_wgc_provider_contract  # 新增代码+Phase42WindowsFinalMatrix: 脚本模式导入 Phase36 合同；如果没有这行代码，bat 入口无法运行 WGC 合同。
