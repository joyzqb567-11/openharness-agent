...
__all__ = ["COMPUTER_USE_CLAUDECODE_ALIGNMENT_MARKER", "evaluate_claudecode_alignment_matrix", "format_claudecode_alignment_summary_line", "get_claudecode_alignment_dimensions", "render_claudecode_alignment_report", "write_claudecode_alignment_outputs"]  # 新增代码+ClaudeCodeAlignmentMatrix：声明稳定公开 API；如果没有这一行，后续模块不清楚哪些名称可以依赖。
