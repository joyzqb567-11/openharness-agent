...
- [ ] `first_status_ms <= 2000` for every real-model turn.
- [ ] `first_transport_warning_ms <= 30000` when WebSocket timeout occurs.
- [ ] `first_delta_ms` is measured separately and never conflated with `first_status_ms`.
- [ ] `cancel_visible_ms <= 500`.
- [ ] `cancel_backend_stop_ms <= 3000` for Codex CLI child process under normal Windows process termination.
- [ ] Stale delta from a cancelled turn never appears in a later turn.
- [ ] Direct OAuth SSE only claims low-latency streaming after probe evidence confirms the endpoint and payload shape.
- [ ] Secret redaction gate passes on all V2 evidence directories.
- [ ] Real visible GUI acceptance passes using `computer-use:computer-use` to confirm and verify the visible OpenHarness Desktop window.
...
- [ ] **Step 1: Write the baseline event parser test**
...
- [ ] **Step 2: Implement `summarize_latency_events()` inside the test file first**
...
- [ ] **Step 3: Run the baseline parser test**
...
- [ ] **Step 4: Capture current GUI event evidence**
...
- [ ] **Step 5: Write the current baseline summary**
...
- [ ] **Step 1: Write tests for phase, sequence, and redaction shape**
...
- [ ] **Step 2: Implement `ModelStreamEvent` and `StreamingChatModel`**
...
- [ ] **Step 1: Add a fake streaming model test**
...
- [ ] **Step 2: Update `RealModelGuiAgentAdapter.run()`**
...
- [ ] **Step 1: Add cancellation race tests**
...
- [ ] **Step 2: Define Windows process behavior**
...
- [ ] **Step 3: Wire frontend cancel to backend cancel**
...
- [ ] **Step 1: Run a minimal real discovery command**
...
- [ ] **Step 3: Add test that event shape document exists and is explicit**
...
- [ ] **Step 4: Run discovery documentation test**
...
- [ ] **Step 1: Write fake process tests**
...
- [ ] **Step 2: Implement `CodexCliStreamingRunner`**
...
- [ ] **Step 3: Keep `CodexCliChatModel.chat()` compatible**
...
- [ ] **Step 1: Add diagnostics parser tests**
...
- [ ] **Step 2: Implement async cache behavior**
...
- [ ] **Step 1: Fast-fail disconnected provider**
...
- [ ] **Step 2: Cache unsupported model failures**
...
- [ ] **Step 1: Add capability probe contract**
...
- [ ] **Step 2: Run probe only when direct OAuth is explicitly configured**
...
- [ ] **Step 3: Do not claim streaming if probe fails**
...
- [ ] **Step 4: Implement SSE stream only after available probe**
...
- [ ] **Step 1: Add redaction unit test**
...
- [ ] **Step 3: Run evidence directory leak scan**
...
- [ ] **Step 4: Apply visible GUI acceptance and bug rule**
