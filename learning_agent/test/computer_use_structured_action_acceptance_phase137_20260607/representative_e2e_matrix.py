...
from learning_agent.computer_use.windows_launch_resolver import build_launch_plan  # 新增代码+Phase74RepresentativeE2E: 复用 Phase69 安全启动计划；如果没有这行代码，代表性场景会重复实现应用启动边界。
