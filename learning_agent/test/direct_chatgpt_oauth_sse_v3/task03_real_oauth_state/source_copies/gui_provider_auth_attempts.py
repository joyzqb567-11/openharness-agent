...
from learning_agent.app.gui_provider_openai_oauth import OpenAIRealOAuthAttemptSecret, build_real_openai_oauth_attempt, store_openai_oauth_token_response  # 新增代码+OpenAIRealOAuthAttempt：导入真实 OAuth URL 构造和 token 保存；如果没有这行，auth-attempt 无法进入真实浏览器 flow。
