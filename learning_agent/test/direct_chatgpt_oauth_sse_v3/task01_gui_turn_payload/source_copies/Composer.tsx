...
export function Composer({ isRunning = false, activeTurnId = null, selectedProviderId = "", selectedModelId = "", reasoningEffort = "high", permissionMode = "full_access", onCancelActiveTurn, onSubmit }: ComposerProps): JSX.Element { // 修改代码+DirectSSEPayload：函数段开始，渲染底部输入工具条并携带模型路由字段；如果没有这段，用户看不到发送 prompt 或取消当前 turn 的入口。
