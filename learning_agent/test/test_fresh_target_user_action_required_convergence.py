...
from learning_agent.core.actionability_state import DESKTOP_USER_ACTION_REQUIRED_MARKER, get_last_actionability_block, get_pending_actionability, record_actionability_from_tool_result, should_block_tool_for_user_action_required, user_action_required_message  # 新增代码+FreshTargetUserAction：导入待实现的用户动作阻断接口；如果没有这一行，测试无法证明 marker 会进入终止态。
