...
import { Activity, Boxes, Bug, Globe2, ListChecks, Settings, Wrench, type LucideIcon } from "lucide-react"; // 修改代码+DesktopGUIToolchainPanel：引入工具链页签图标；如果没有这行，工具链清单页签会缺少可扫描符号。
...
type InspectorTabId = "status" | "tools" | "toolchain" | "browser" | "harness" | "settings" | "diagnostics"; // 修改代码+DesktopGUIToolchainPanel：限定右侧检查器页签 id 并加入工具链页；如果没有这行，工具链清单无法被选中。
