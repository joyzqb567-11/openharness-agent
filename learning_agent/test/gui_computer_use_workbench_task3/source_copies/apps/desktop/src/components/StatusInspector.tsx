...
export function StatusInspector({ events, browserProviderStatus, runtimePanels = {}, toolchainPayload = {}, harnessPayload = {}, bridgeBaseUrl = "", healthPayload = {}, diagnosticsPayload = {}, onProbeUnknownRoute, onPauseHarness, onResumeHarness, onStopHarness, onCheckpointHarness, harnessControlPending = false, lastHarnessControlResult = {}, onRequestComputerUseAccess, onObserveComputerUse, onAbortComputerUse, computerUseActionPending = false, lastComputerUseActionResult = {} }: StatusInspectorProps): JSX.Element { // 修改代码+DesktopGUIComputerUseWorkbench：函数段开始，渲染右侧多页签检查器并转发 Harness 与 Computer Use 控制；如果没有这段，浏览器页签按钮无法真正调用后端。
