...
export function StatusInspector({ events, browserProviderStatus, runtimePanels = {}, toolchainPayload = {}, harnessPayload = {}, bridgeBaseUrl = "", healthPayload = {}, diagnosticsPayload = {}, onProbeUnknownRoute, onPauseHarness, onResumeHarness, harnessControlPending = false }: StatusInspectorProps): JSX.Element { // 修改代码+DesktopGUIToolchainPanel：函数段开始，渲染右侧多页签检查器并接入工具链清单；如果没有这段，用户看不到运行、工具、链路、浏览器、任务、设置和诊断信息。
