...
from learning_agent.computer_use_mcp_v2.windows_runtime.action_gates import computer_use_agent_owned_launch_rejection  # 新增代码+FreshTargetTargetRefGateTest：导入被测动作门禁；如果没有这一行，测试无法覆盖权限前拒绝。
