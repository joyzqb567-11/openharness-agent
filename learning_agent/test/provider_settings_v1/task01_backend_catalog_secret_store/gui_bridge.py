...
from learning_agent.app.gui_provider_settings import build_provider_settings_payload  # 新增代码+ProviderSettings：导入 Provider 设置 catalog helper；如果没有这行，bridge 无法返回 provider/model 设置页数据。
