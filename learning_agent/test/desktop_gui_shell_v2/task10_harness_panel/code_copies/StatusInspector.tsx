...
export function StatusInspector({ events, browserProviderStatus, runtimePanels = {}, harnessPayload = {}, bridgeBaseUrl = "", healthPayload = {}, diagnosticsPayload = {}, onPauseHarness, onResumeHarness, harnessControlPending = false }: StatusInspectorProps): JSX.Element { // 修改代码+DesktopGUIHarnessPanel：函数段开始，渲染右侧多页签检查器并接入 Harness；如果没有这段，用户看不到运行、工具、浏览器、任务、设置和诊断信息。
