...
- [ ] V2 visible GUI: tool trace row.
- [ ] V2 visible GUI: permission approve/deny.
...
- [ ] V2 visible GUI: diagnostics panel copies safe diagnostic bundle.
- [ ] V2 visible GUI: window restart restores latest V2 session.
