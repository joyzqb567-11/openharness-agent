...
APP_NAME_HIGH_RISK_TOKENS = ("powershell", "pwsh", "cmd", "command prompt", "terminal", "wt", "regedit", "registry", "control", "settings", "mmc", "taskmgr", "administrator", "administrative tools", "credential", "password", "security", "firewall", "defender", "services", "wsl")  # 修改代码+AppNames：补充真实日志暴露出的命令提示符、管理工具和 WSL 等系统入口；如果没有这一行，模型仍可能把终端类工具当成普通桌面应用。
