...
export function StatusInspector({ events, browserProviderStatus, runtimePanels = {}, toolchainPayload = {}, harnessPayload = {}, bridgeBaseUrl = "", healthPayload = {}, diagnosticsPayload = {}, onProbeUnknownRoute, onPauseHarness, onResumeHarness, onStopHarness, onCheckpointHarness, harnessControlPending = false, lastHarnessControlResult = {} }: StatusInspectorProps): JSX.Element { // 修改代码+DesktopGUIHarnessControlsPanel：函数段开始，渲染右侧多页签检查器并转发真实 Harness 控制；如果没有这段，用户看不到运行、工具、链路、浏览器、任务、设置和诊断信息。
