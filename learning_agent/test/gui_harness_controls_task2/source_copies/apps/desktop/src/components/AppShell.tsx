...
import { createGuiClient, type GuiHarnessControlPayload } from "../api/guiClient"; // 修改代码+DesktopGUIHarnessControlsShell：引入 GUI bridge 客户端工厂和 Harness 控制响应类型；如果没有这行，前端无法类型化真实控制结果。
