...
import { Activity, Boxes, Bug, ClipboardCheck, Globe2, ListChecks, Network, Settings, Terminal, Wrench, type LucideIcon } from "lucide-react"; // 修改代码+DesktopGUIAcceptancePanel：引入验收页签 ClipboardCheck 图标；如果没有这行，验收入口缺少可扫描符号。
...
type InspectorTabId = "status" | "tools" | "toolchain" | "mcp" | "planning" | "commands" | "acceptance" | "browser" | "harness" | "settings" | "diagnostics"; // 修改代码+DesktopGUIAcceptancePanel：限定右侧检查器页签 id 并加入验收页；如果没有这行，验收页无法被选中。
