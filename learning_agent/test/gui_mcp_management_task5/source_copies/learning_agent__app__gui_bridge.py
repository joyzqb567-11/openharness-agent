...
from learning_agent.app.gui_toolchain import build_gui_toolchain_payload  # 新增代码+DesktopGUIToolchain：导入工具链清单 helper；如果没有这行，GUI bridge 无法复用已有工具目录生成 Toolchain 面板数据。
