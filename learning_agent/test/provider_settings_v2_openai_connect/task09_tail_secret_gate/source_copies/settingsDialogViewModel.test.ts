...
import { authAttemptPollDecision, shouldPollAuthAttempt } from "../src/components/settings/SettingsDialog"; // 修改代码+OpenAIConnectPollRaceTest：导入 auth-attempt 轮询决策和开关 helper；如果没有这行，测试无法锁住 complete 刷新顺序和终态停止轮询规则。
