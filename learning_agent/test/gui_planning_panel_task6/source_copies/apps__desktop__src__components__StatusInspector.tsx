...
type InspectorTabId = "status" | "tools" | "toolchain" | "mcp" | "planning" | "browser" | "harness" | "settings" | "diagnostics"; // 修改代码+DesktopGUIPlanningPanel：限定右侧检查器页签 id 并加入计划页；如果没有这行，计划协作页无法被选中。
