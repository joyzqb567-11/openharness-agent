...
- [ ] URG-5 Paint/Pikachu real representative acceptance.
...
URG-4 is now the active implementation task. URG-3 has a safe recording-sender bridge with low-level event auditing, but it still must not be described as mature physical desktop dispatch.
